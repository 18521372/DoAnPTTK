 ...
 * @author ACER
 */
public class QuanLyKiemKePanel extends javax.swing.JPanel {
    ...
    JPanel root;
    public QuanLyKiemKePanel(JPanel root) {
        this.root=root;
        initComponents();
        jTextField1.getDocument().addDocumentListener(new DocumentListener() {
            ...
            public void LamMoi() {
                try{
                    MaPKK=Integer.parseInt(jTextField1.getText());
                }catch(NumberFormatException e){
                    MaPKK=-1;
                }    
                PKK=ctrl.GetDataPhieuKiemKe(MaPKK);
                if(PKK.getStatusflag()!=-1){   
                    jTextField2.setText(Integer.toString(PKK.getManv()));
                    jTextField5.setText(Integer.toString(PKK.getManv()));
                    jTextField7.setText(String.valueOf(PKK.getNgayphieukiemke()));
                    jTextField3.setText(Integer.toString(PKK.getTrigia()));
        ...
        jTable1.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent e) {
               try{ MaPKK=(int) jTable1.getValueAt(jTable1.getSelectedRow(),0);
                jTextField1.setText(String.valueOf(MaPKK));
               }catch(java.lang.ArrayIndexOutOfBoundsException ex){
               }
            }
        });
        ctrl.ShowDataPhieuKiemKe(jTable1);
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã phiếu kiểm kê", "Mã nhân viên", "Ngày lập phiếu", "Giá trị thay đổi"
            }
        ));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        root.removeAll();
        root.add(new ThemPhieuKiemKePanel(root));
        root.validate();
        root.repaint();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(MaPKK!=-1){
            root.removeAll();
            root.add(new XemPhieuKiemKePanel(MaPKK,root));
            root.validate();
            root.repaint();
        }
