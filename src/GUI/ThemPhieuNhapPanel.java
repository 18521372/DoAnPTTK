 ...
 * @author ACER
 */
public class ThemPhieuNhapPanel extends javax.swing.JPanel {
    ...
    JPanel root;
    public HangHoa HH;
    public ThemPhieuNhapPanel(JPanel root) {
        this.root=root;
        PN=new PhieuNhap();
        Byte i=-1;
        HH=new HangHoa();
        ...
        jTextField1.getDocument().addDocumentListener(new DocumentListener() {
            ...
            public void LamMoi() {
                ...
                for(HangHoa DongCoSang:PN.getListHangHoa()){
    ...
    private void initComponents() {
        ...
        jButton1.setText("Lưu phiếu nhập");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        for(HangHoa DongCoSang:PN.getListHangHoa()){
            if(HH.getMahanghoa()==DongCoSang.getMahanghoa()){
                ...
                ctrl.ShowDataCTPN(jTable1,PN.getListHangHoa());
                return;
            }
        }
        if(HH.getStatusflag()!=-1){
            PN.getListHangHoa().add(HH);
            PN.setTrigia(PN.getTrigia()+(HH.getDongia()*HH.getSoluong()));
            ctrl.ShowDataCTPN(jTable1,PN.getListHangHoa());
            Byte i=1;
            PN.setStatusflag(i);
            jButton3.setText("Sửa dòng");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        PN.setManv(MenuGUI.manv);
        java.util.Date gt=new java.util.Date();
        long l=gt.getTime();
        Date SDate=new java.sql.Date(l);
        PN.setNgayphieunhap( SDate);
        Byte a=0;
        PN.setStatusflag(a);
        new BQuanLyKho().ThemPhieuNhap(PN);
        root.removeAll();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        for(int i=0;i<PN.getListHangHoa().size();i++){
            HangHoa DongCoSang=PN.getListHangHoa().get(i);
            if(HH.getMahanghoa()==DongCoSang.getMahanghoa()){
                PN.getListHangHoa().remove(DongCoSang);
                jButton3.setText("Thêm dòng");
                ctrl.ShowDataCTPN(jTable1,PN.getListHangHoa());
            }
        }
