 ...
 * @author ACER
 */
public class XemPhieuKiemKePanel extends javax.swing.JPanel {
    ...
    int MaPKK=-1;
    PhieuKiemKe PKK;
    public XemPhieuKiemKePanel(int MaPKK,JPanel root) {
        this.root=root;
        this.MaPKK=MaPKK;
        initComponents();
        ctrl.ShowDataCTPKK(jTable1,ctrl.GetDataPhieuKiemKe(MaPKK).getListHangHoa());
    }
